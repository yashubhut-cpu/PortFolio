...
export const FAQSection: React.FC = () => {
  ...
  return (
    <section id="faq" className="py-16 sm:py-24 bg-[#fefae0] dark:bg-[#1a1a2e] border-t-2 border-black dark:border-[#e85d04] transition-colors duration-300">
          ...
          {faqsData.map((faq) => {
            ...
            return (
              ...
              >
                ...
                {isOpen && (
                  <div className="px-5 pb-5 pt-1 border-t border-stone-200 dark:border-stone-800 bg-stone-50/50 dark:bg-[#16213e]">
