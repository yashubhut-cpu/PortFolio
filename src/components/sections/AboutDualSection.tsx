...
export const AboutDualSection: React.FC<AboutDualSectionProps> = ({ onExploreServices }) => {
  return (
    <section
      ...
      className="relative z-20 bg-[#fefae0] dark:bg-[#1a1a2e] w-full border-t-3 border-black dark:border-[#e85d04] py-16 sm:py-24 shadow-[0_-8px_30px_rgba(0,0,0,0.12)] transition-colors duration-300"
    >
      <div className="max-w-[#1280px] mx-auto px-4 sm:px-10 space-y-12 sm:space-y-16">
        ...
        <div className="text-center space-y-4 px-1 max-w-3xl mx-auto">
          <h2
            id="about-heading"
            className="font-montserrat text-2xl min-[360px]:text-3xl sm:text-4xl md:text-5xl font-black uppercase text-[#1a1a2e] dark:text-[#e85d04] tracking-tight"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10">
          ...
          <article className="p-6 sm:p-8 border-3 border-black dark:border-[#e85d04] bg-white dark:bg-[#16213e] neobrutal-shadow flex flex-col justify-between space-y-6 h-full hover:-translate-y-1 transition-all">
            ...
            <button
              ...
              aria-label="Explore Engineering Services by Yash Bhut"
              title="Explore Engineering Services"
          ...
          <article className="p-6 sm:p-8 border-3 border-black dark:border-[#e85d04] bg-white dark:bg-[#16213e] neobrutal-shadow flex flex-col justify-between space-y-6 h-full hover:-translate-y-1 transition-all">
            ...
            <button
              onClick={onExploreServices}
              aria-label="Explore Startup Solutions by Yash Bhut"
              title="Explore Startup Solutions"
