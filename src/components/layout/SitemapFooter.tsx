...
export const SitemapFooter: React.FC = () => {
  ...
  return (
    <section className="mb-12 border-t-2 border-black/10 dark:border-[#e85d04]/20 pt-12">
      <div className="text-center space-y-2 mb-8">
        <h2 className="font-montserrat text-2xl sm:text-3xl font-black uppercase text-[#1a1a2e] dark:text-[#e85d04]">
